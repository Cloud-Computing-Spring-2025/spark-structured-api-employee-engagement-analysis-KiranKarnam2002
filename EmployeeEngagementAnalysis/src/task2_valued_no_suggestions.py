...
# Load Employee Data
df = spark.read.csv("/workspaces/spark-structured-api-employee-engagement-analysis-KiranKarnam2002/EmployeeEngagementAnalysis/input/employee_data.csv", header=True, inferSchema=True)
